...
HD_PWD='E:/MIPS_CPU/p_MIPS_CPU/p_MIPS_CPU.runs/data_ram3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_ram3.vds -m64 -mode batch -messageDb vivado.pb -notrace -source data_ram3.tcl
