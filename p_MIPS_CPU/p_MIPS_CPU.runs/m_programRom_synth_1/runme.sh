...
HD_PWD='E:/MIPS_CPU/p_MIPS_CPU/p_MIPS_CPU.runs/m_programRom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m_programRom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source m_programRom.tcl
