...
HD_PWD='E:/MIPS_CPU/p_MIPS_CPU/p_MIPS_CPU.runs/Branch_adder_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Branch_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Branch_adder.tcl
