...
HD_PWD='E:/MIPS_CPU/p_MIPS_CPU/p_MIPS_CPU.runs/c_addsub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_addsub.vds -m64 -mode batch -messageDb vivado.pb -notrace -source c_addsub.tcl
