...
#
# Generated by export_simulation on Tue Sep 26 15:01:09 +0800 2017
#
################################################################################
...
switch to the './c_addsub.sh' script.

./c_addsub.sh -reset_run
...
./c_addsub.sh -noclean_files

For more information on the script, please type './c_addsub.sh -help'.
