...
#
# Generated by export_simulation on Tue Sep 26 14:59:54 +0800 2017
#
################################################################################
...
switch to the './mult_adder64bit.sh' script.

./mult_adder64bit.sh -reset_run
...
./mult_adder64bit.sh -noclean_files

For more information on the script, please type './mult_adder64bit.sh -help'.
