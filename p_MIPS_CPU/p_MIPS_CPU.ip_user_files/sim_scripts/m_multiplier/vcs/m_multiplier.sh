...
reset_run()
{
  files_to_remove=(ucli.key m_multiplier_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc m_multiplier_simv.daidir)
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.m_multiplier -o m_multiplier_simv
}
...
simulate()
{
  ...
  ./m_multiplier_simv $opts -do simulate.do
}
# Script usage
usage()
{
