...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb m_multiplier.wdb xsim.dir)
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 934dcbaca86a4af1b40efb6b405cce7a -m64 -L xbip_utils_v3_0_5 -L xbip_pipe_v3_0_1 -L xbip_bram18k_v3_0_1 -L mult_gen_v12_0_10 -L xil_defaultlib -L secureip --snapshot m_multiplier xil_defaultlib.m_multiplier -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim m_multiplier -key {Behavioral:sim_1:Functional:m_multiplier} -tclbatch cmd.tcl -log simulate.log
}
# Script usage
usage()
{
