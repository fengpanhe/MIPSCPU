...
#
# Generated by Vivado on Sat Oct 14 19:16:40 +0800 2017
...
# executing this script. Please type 'm_divider.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key m_divider_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc m_divider_simv.daidir)
...
create_lib_mappings()
{
  libs=(xbip_utils_v3_0_5 axi_utils_v2_0_1 xbip_pipe_v3_0_1 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_1 xbip_bram18k_v3_0_1 mult_gen_v12_0_10 floating_point_v7_0_11 xbip_dsp48_mult_v3_0_1 xbip_dsp48_multadd_v3_0_1 div_gen_v5_1_9 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work xbip_dsp48_mult_v3_0_1 $opts_vhd \
    "$ref_dir/../../../ipstatic/xbip_dsp48_mult_v3_0_1/hdl/xbip_dsp48_mult_v3_0_vh_rfs.vhd" \
    "$ref_dir/../../../ipstatic/xbip_dsp48_mult_v3_0_1/hdl/xbip_dsp48_mult_v3_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work div_gen_v5_1_9 $opts_vhd \
    "$ref_dir/../../../ipstatic/div_gen_v5_1_9/hdl/div_gen_v5_1_vh_rfs.vhd" \
    "$ref_dir/../../../ipstatic/div_gen_v5_1_9/hdl/div_gen_v5_1.vhd" \
  2>&1 | tee -a vhdlan.log

  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../p_MIPS_CPU.srcs/sources_1/ip/m_divider/sim/m_divider.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.m_divider -o m_divider_simv
}
...
simulate()
{
  ...
  ./m_divider_simv $opts -do simulate.do
}
# Script usage
usage()
{
