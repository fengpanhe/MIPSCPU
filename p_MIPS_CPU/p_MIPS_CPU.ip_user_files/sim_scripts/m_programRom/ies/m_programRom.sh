...
#
# Generated by Vivado on Thu Oct 12 09:10:46 +0800 2017
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.m_programRom $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.m_programRom -input simulate.do
}
# Script usage
usage()
{
